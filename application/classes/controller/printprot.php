...
//    $pdf->Cell(65, 5, $rs->sigla, 'TR',FALSE,'C');
                ...
                //MODIFICADO POR QC
                /*if($rs->id_tipo != 6)
                {   $pdf->Cell(25, 5, 'PROCESO', 'LTB', FALSE, 'l');$pdf->Cell(47, 5, $rs->proceso, 'TRB', 'L');
                }else
                {   $pdf->Cell(25, 5, '', 'LTB', FALSE, 'l');$pdf->Cell(47, 5, '', 'TRB', 'L');
                } */
                ...
                if ($t <= 7) {
                    for ($i = 1; $i <= (7 - $t); $i++) {
                        ...
                        $pdf->SetFontSize(10);
                        $pdf->SetFillColor(240, 245, 255);
                        $pdf->Cell(60, 7, 'SIGUIENTE DESTINATARIO Nro. '.$i.':', 1, FALSE, 'L', true);
                        $pdf->SetFillColor(0);
