            ...
            $.ajax({
                ...
                success: function (jsondata)
                {
                    ...
                    if (estado == 'ok') {
                        ...
                        $('div#e' + entrada).addClass('animated zoomOut');
                        $('div#e' + entrada).remove();
                    }
                    else
                    {
                        alert(obj.error);
...
<?php if (sizeof($entrada) > 0) { ?>
    <div style=";position: fixed; z-index: 1; margin-top: -24px; padding: 2px; background: #fff; width: 100%;" class="col-lg-12 col-md-12">
        <div class="col-md-5">
                    ...
                    <table class="oficial<?php echo $s->oficial; ?> ">
                        <tr>
                            ...
                            <td valign="top" colspan="3" >
                                <h4 class="text-primary-dark"><!--<a href="/document/detalle/<?php //echo $s->id_doc ?>" ><?php //echo $s->referencia; ?></a>--><?php echo $s->referencia; ?></h4>		
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="derecha" valign="top">     
                                ...
                                <br/><span class=" text-accent-dark"><?php echo $s->accion; ?></span><br/><?php /* QC correspondence->bandeja target="blanck"*/?>                                                                    
                        ...
                        <tr>
                            ...
                            <td>                
                                <span class="opciones"> 
                                    <a href="javascript:;" entrada="<?php echo $i; ?>" class="recibir btn btn-primary-dark btn-sm" data-toggle="modal" data-target="#simpleModal" nur="<?php echo $s->id; ?>" hr="<?php echo $s->nur; ?>"><i class="md md-inbox"></i> Recibir</a>
